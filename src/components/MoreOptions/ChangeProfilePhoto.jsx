...
import { removePhotoProfile, updatePhotoProfile } from "../../context/authContext/service";
...
function ChangeProfilePhoto() {
    ...
    return (
        <ul className=" bg-ig-primary-background w-[400px] z-100 rounded-xl">
            ...
            <li className="text-sm text-center text-sky-500 bg-transparent  px-2 py-3  border-0 hover:bg-gray-100 border-t border-ig-elevated-separator cursor-pointer">
                <input
                    className="hidden"
                    type="file"
                    id="file"
