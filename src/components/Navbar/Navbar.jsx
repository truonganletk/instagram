    ...
    <div className="flex justify-around sm:basis-1/3 basis-2/3">
      ...
      <div className="flex justify-center" ref={ref}>
        <div className="dropdown relative">
          ...
          <ul
            className="w-[500px] dropdown-menu absolute hidden bg-white text-base z-50 float-left pt-2 list-none text-left rounded-lg shadow-lg mt-1 hidden mx-3 bg-clip-padding border-none"
      ...
      <div className="flex justify-center h" ref={ref2}>
        <div className="dropdown relative">
          ...
          <ul
            className=" dropdown-menu min-w-max absolute hidden bg-white text-base z-50 float-left py-2  px-5 list-none text-left rounded-lg shadow-lg mt-1 hidden mx-3 bg-clip-padding border-none"
            aria-labelledby="dropdownMenuButton1"
          >
            <li>
              <a
