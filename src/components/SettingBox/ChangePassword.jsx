    ...
    return (
      ...
      <form className='p-10 basis-full md:basis-9/12'>
        ...
        <div className="mb-6 flex w-full items-center">
          <label htmlFor="email" className="block text-sm font-medium text-gray-900 basis-3/12 ">Old password</label>
        ...
        <div className="mb-6 flex w-full items-center">
          <label htmlFor="email" className="block text-sm font-medium text-gray-900 basis-3/12 ">New password</label>
          <input type="password" id="email" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 " placeholder="" required />
        </div>
        <div className="mb-6 flex w-full items-center">
          <label htmlFor="email" className="block text-sm font-medium text-gray-900 basis-3/12 ">Confirm new password</label>
          <input type="password" id="email" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 " placeholder="" required />
        </div>        
        ...
        <div className="flex items-start mb-6">
          <label className="ml-2 text-sm font-medium text-sky-500">Remember me</label>
        </div>
      </form>
