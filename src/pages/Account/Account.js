        ...
        <>
            ...
            <main className='max-w-[935px] mx-auto mt-8'>
                <header className='flex justify-center space-x-28 flex-1 mb-11'>
                    {/* avatar */}
                    <img className='w-44 h-44 border rounded-full p-[2px]' src="https://avatarfiles.alphacoders.com/102/102783.jpg" alt="" />
                        ...
                        <div className='flex space-x-5 items-center '>
                            ...
                            <div>
                                <div className='flex space-x-2'>
                                    ...
                                    <button className='bg-transparent border-[1px] rounded px-5 py-[5px] cursor-pointer text-sm font-semibold'>Follow</button>
                                </div>
                            </div>
