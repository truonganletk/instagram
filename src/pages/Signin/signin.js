                    ...
                    <form className='flex flex-col w-full'>
                        <div className='mt-6 flex flex-col'>
                            <div className='mx-10 mb-2'>
                                <input className='box-border text-base w-full bg-ig-secondary-background pt-[9px] pb-[7px] pl-2 text-ig-primary-text border border-solid rounded border-ig-stroke outline-none' type="text" placeholder='Phone, username or email' />
                            </div>
                            <div className='mx-10 mb-2'>
                            ...
                            <div className='mx-10 my-2'>
                                <button className='w-full cursor-pointer box-border text-sm font-semibold py-[5px] px-[9px] bg-ig-primary-button rounded text-white' type="submit">Log in</button>
                            </div>
